...
export default function GridItem({ xid, image, title, description, rating, country }) {
    ...
    return <div className="card border-0 shadow-sm h-100" aria-labelledby={UID} itemScope>
        ...
        <div className="card-body">
            <a href={`/search/${xid}`} target={xid} className="btn btn-sm d-block btn-outline-secondary border-0 card-title mb-3">{title || 'Unnamed spot'}</a>
